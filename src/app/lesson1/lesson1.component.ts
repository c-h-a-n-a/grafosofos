...
export class Lesson1Component {
  ...
  quizQuestions: QuizQuestion[] = [
    { 
      text: 'It is the practice of journalism found in educational settings.',
      options: ['Campus Journalism', 'Magazines', 'Reporting', 'Blogs'],
      correctAnswer: 0
    },
    { 
      text: 'What century did the radio, television, and the internet emerged?',
      options: ['19th century', '20th century', '18th century', '16th century'],
      correctAnswer: 1
    },
    { 
      text: 'What year did the history of college journalism in the Philippines began with the publication of El Liliputiense by the UST?',
      options: ['1980', '1819', '1890', '1987'],
      correctAnswer: 2
    },
    { 
      text: 'It is the frequently produced by student-run publications, magazines, blogs, and radio.',
      options: ['News', 'Blogs', 'Radio', 'Reports'],
      correctAnswer: 3
    },
    { 
      text: 'What year is the history of journalism in the Philippine Islands?',
      options: ['1890', '1964', '1896', '1933'],
      correctAnswer: 3
    },
    { 
      text: 'What year is John Lent in the Philippine Mass Communication?',
      options: ['1962', '1890', '1964', '1933'],
      correctAnswer: 2
    },
    { 
      text: 'Campus Journalism provides student a voice to discuss important issues and events.',
      options: ['False', 'True'],
      correctAnswer: 1
    },
    { 
      text: 'Campus Journalism helps student become more aware and engaged citizens by teaching them about current issues.',
      options: ['False', 'True'],
      correctAnswer: 0
    },
    { 
      text: 'Schools should support campus journalism program to develop students and uphold principles of free expression and civic participation.',
      options: ['False', 'True'],
      correctAnswer: 1
    },
    { 
      text: 'Student journalism cannot be included into a variety of courses and taught alongside disciplines like physics and history. ',
      options: ['False', 'True'],
      correctAnswer: 1
    },
